...
{
    public class BirdFoodRequirement : IFoodRequirement
    {
        public double DailyQuantity { get; private set; }
        public List<string> PreferredFoodTypes { get; private set; }

        public BirdFoodRequirement(double animalWeight)
        {
            DailyQuantity = animalWeight * 0.05;
            PreferredFoodTypes = new List<string> { "Seeds", "Insects", "Fruits" };
        }
