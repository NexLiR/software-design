...
namespace Abstract_Factory.Products.Smartphones
{
    class SamsungSmartphone : ISmartphone
    {
        ...
        public SamsungSmartphone(string modelName, int yearOfManufacture, string storageSize)
        {
            ModelName = modelName;
        ...
        public void Display()
        {
            Console.WriteLine($"Samsung Smartphone {ModelName} {StorageSize} {YearOfManufacture}");
        }
    }
}
